...
import com.google.mlkit.vision.demo.java.Page2StartingActivity
...
class EntryChoiceActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    findViewById<Button>(R.id.FirstPage_to_SecondPage_Button).setOnClickListener{
      val intent = Intent(this@EntryChoiceActivity, Page2StartingActivity::class.java)
